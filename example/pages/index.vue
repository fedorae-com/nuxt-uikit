    ...
    <div class="uk-container">
      <div class="uk-margin-top">
        <div class="uk-card uk-card-default uk-card-body uk-width-1-1@m">
          <h3 class="uk-card-title">UIkit module for Nuxt.js</h3>
          ...
          <div class="uk-margin-small-bottom">
            <a href="https://github.com/fedorae-com/nuxt-uikit-module" target="_blank" rel="noopener noreferrer" class="uk-icon-button" uk-icon="github"></a>
          </div>
